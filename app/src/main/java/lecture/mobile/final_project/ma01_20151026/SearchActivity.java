...
public class SearchActivity extends AppCompatActivity
    ...
    private static final String TAG = "ma01_20151026";
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.btn_search_restraunts:
                showPlaceInformation(currentPosition);

                cameraUpdate = CameraUpdateFactory.newLatLng(currentPosition);
                mGoogleMap.moveCamera(cameraUpdate);

                break;

            case R.id.btn_search_from_address:
                geoCoder = new Geocoder(this);

                List<Address> addressList = null;

                String addressName = ((EditText)findViewById(R.id.et_location)).getText().toString();
                ...
                showPlaceInformation(mPosition);
    ...
    public void showPlaceInformation(LatLng location)
    {
        ...
        new NRPlaces.Builder()
                ...
                .key("AIzaSyAy-c-weex533wMAcFchvjBYr-KQZvNXP8")
                .latlng(location.latitude, location.longitude) // 현재 위치
                .radius(500) // 500 미터 내에서 검색
                .type(PlaceType.RESTAURANT) // 음식점만
                .build()
                .execute();
    }
}